---
title: How to safely expose OctoPrint to the internet using Cloudflare Tunnels and Access.
date: '2024-02-09'
tags: ['octoprint']
draft: false
summary: Short article on how to use Cloudflare Tunnels and Access to provide a secure gateway to your 3D printer using OctoPrint.
---
