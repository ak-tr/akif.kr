...
Note: This section has been added after relase of this blog post.

As a final test, I played a 40 minute session of BeamNG.drive. Please note that this was done after my PBO2 undervolt. The results are promising.

<PostImage src="/static/images/custom-loop-charts/temp_beamng.png" alt="BeamNG.drive performance" />

In this chart I have plotted the CPU, GPU and liquid temperatures over time. We can see that the temperatures stabilise around 10-15 minutes into gameplay and are very good for the single radiator setup.

<PostImage src="/static/images/custom-loop-charts/power_beamng.png" alt="BeamNG.drive performance" />

We can also see that it is consuming around 380W through most of the gameplay, and around 360W on average.

At its loudest, the pump is running at 2700RPM and the radiator fans run at around 1500RPM.
