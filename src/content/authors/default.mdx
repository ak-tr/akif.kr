...
<Card 
  ...
  description={
    [
      ...
      "It's simple, focused, and built for people who want automation without losing control. We're iterating fast.",
      "Potzo is now open to beta users, and people from the waitlist are already using it. Click the link below to get started."
    ]
  } 
  link={{
    text: "Visit potzo.cc",
